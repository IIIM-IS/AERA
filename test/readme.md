...
* **Running tests from command line:** Alternatively, you can execute the tests directly from the command line by navigating to the Release folder from the project root and running `test.exe`. 
  ```cmd
  C:\Users\shmax\source\repos\AERA>cd Release
  C:\Users\shmax\source\repos\AERA\Release>test
  ```
  You can also apply filters to run specific tests, for example: 
  ```cmd
  C:\Users\shmax\source\repos\AERA\Release>test --gtest_filter=3_CUMULATIVE_LEARNING*
---
